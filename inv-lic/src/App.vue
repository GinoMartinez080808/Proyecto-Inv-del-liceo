...
<template>
  ...
  "> < </p>
        <li v-if="linksM == true" @click="()=>{
           mateM = false;
           linksM = false;
        }" class="matematica">Matematica</li>
        <li v-if="linksM == true" @click="()=>{
           fisicaM = false;
           linksM = false;
        }" class="fisica">Fisica</li>
        <li v-if="linksM == true" @click="() =>{
           quimicaM = false;
           linksM = false;
        }" class="quimica">Quimica</li>
        <li v-if="linksM == true" @click="()=>{
 literaturaM = false;
 linksM = false;
        }" class="literatura">Literatura</li>
        <li v-if="linksM == true" @click="()=>{
           ciM = false;
           linksM = false;
        }" class="ci">Ciencia de la tierra</li>
        <li v-if="linksM == true" @click="()=>{
 ghcM = false;
 linksM = false;
        }" class="ghc">GHC</li>
