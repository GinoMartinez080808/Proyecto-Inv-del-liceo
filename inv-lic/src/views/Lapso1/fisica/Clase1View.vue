...
<template>
  <div class="pag">
    <div style="width: 100%; display: flex; align-items: center; justify-content: center; height: 10%;">
        <h2>Despejes (<span style="color: red; font-weight: bold;">Repaso</span>)</h2>
    </div>
    
    <br>
    <h3 style="color: cadetblue; font-weight: bold;">¿Que es el despeje?:</h3>
    <br> 
    <h4>Cuando hablamos de un despeje, nos referimos (al menos en matemáticas) a la "acción de separar una incógnita o variable de otras cantidades que la acompañen mediante el uso de procedimientos de cálculo". Esto último incluye desde realizar una simple suma o resta hasta el despeje usando integrales y derivadas.

</h4>
<br>
<h4>Ahora bien, ¿A qué cantidades nos referimos? Bueno, no son más que aquellos números que acompañan a una literal como: un exponente, un coeficiente o una constante. 

 </h4>
 <br>
 <h3>Ejemplo del platillo de ingredientes:</h3>
<br>
<h4>Para entender la idea principal de un despeje imaginemos lo siguiente: alguien empezó con la x (o cualquier variable) sola, con exponente 1 y coeficiente 1. Luego algo pasó por su mente y decidió multiplicarla por 7, obteniendo así 7x. Posteriormente decidió elevar al cuadrado su resultado anterior, obteniendo así 49x^2. Por último decidió restarle al resultado anterior 10, terminando con 49x^2 - 10.
...
<br>
<h4>Empezaremos por el despeje que involucran sumas y restas: Este procedimiento ayuda a que términos que no contienen la variable a despejar o que simplemente no están en el lugar que queremos sean re-ubicados para poder realizar simplificaciones (como sucede con los términos semejantes).</h4>
<br>
<h4>
...
<br>
<h4>
    1.- Eliminar cualquier paréntesis, corchete o llaves que existan. para esto realizaremos la propiedad distributiva de la multiplicación del número que se encuentra fuera del paréntesis por términos dentro del paréntesis (respetando la ley de signos del producto).</h4>
    <br>
    <h4>
    ...
    <br>
    <h4 style="color: red;">Nota que en este paso realizamos despejes al eliminar los términos que no deben acompañar a la x o que no la contienen. Para ello, si el término que queremos eliminar es positivo, agregamos ese mismo término con el signo contrario (esto ejemplifica lo de operaciones contrarias) y viceversa. Recuerda que al ser una ecuación, este término extra debe agregarse a ambos lados de la igualdad, de ahi que se diga: Si está sumando, pasa al otro lado restando o viceversa, aunque simplemente hemos agregado un término de un lado que elimina a otro (vea las flechas en rojo) y que también aparece del otro lado del igual.
    </h4>
    <br>
    <h4>
...
4.- Comprobar el resultado al sustituir x=20, realizar todos los cálculos y comprobar que la igualdad de cumpla (el resultado debe ser el mismo en ambos lados del igual).
    ...
    <br>
    <h3 style="color: cadetblue; font-weight: bold;">
...
<br>
<h3  style="color: cadetblue; font-weight: bold;">Conclusiones:</h3>
<br>
